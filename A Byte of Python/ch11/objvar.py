...
# All class member (including the data members) are public and all the methods are virtual in Python.
# One exception: If you are data members with names using the double underscore prefix such as
