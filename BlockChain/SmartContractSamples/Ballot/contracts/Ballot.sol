...
contract Ballot {
    ...
    struct Proposal {
        ...
        uint voteCount;   // number of accumlated votes
    }
    ...
    function Ballot(bytes32[] proposalNames) public {
        ...
        // For each of the provoded proposal names, 
    ...
    function delegate(address to) public {
        ...
        // modifies `votes[msg.sender].voted`
        sender.voted = true;
        sender.delegate = to;
    ...
    // Computing the winning proposal taking all 
    ...
    function getProposalNames() public returns (bytes32[]) {
